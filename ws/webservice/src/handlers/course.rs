...
pub async fn update_course_details(
    ...
    let (teacher_id, course_id) = params.into_inner();
    update_course_datails_db(&app_state.db, teacher_id, course_id, update_course.into())
        .await
        .map(|course| HttpResponse::Ok().json(course))
}
...
mod tests {
    ...
    async fn post_course_test() {
        ...
        let course = web::Json(CreateCourse {
            ...
            format: Some("None".into()),
            structure: Some("None".into()),
            duration: Some("None".into()),
            price: Some(32),
    ...
    async fn update_course_success() {
        ...
        let resp = update_course_details(app_state, update_params, params)
            .await
            .unwrap();
